...
export default function AdminQuotePage() {
  ...
  async function saveChanges() {
    if (!window.confirm("Save these quote changes and email the customer that the previously sent quote has changed?")) return;
    const saved = await saveDraft(false);
    if (saved) navigate(`/admin/requests/${encodeURIComponent(id)}`, { replace: true });
  }
